...
🔹 4. EC2 with Security Group + Outputs Security Group resource "aws_security_group" "aws_sg" { ingress { from_port = 80 to_port = 80 protocol = "tcp" cidr_blocks = ["0.0.0.0/0"] } }
...
🔹 6. Terraform Variables & tfvars variables.tf variable "ami" {} variable "instance_type" {} variable "env" {}
...
▶️ How to Run terraform init terraform plan terraform apply
